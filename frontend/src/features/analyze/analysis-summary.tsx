        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-700">Ethical Score</span>
              </div>
              <span className="text-sm font-semibold text-gray-900">{ethicalScore}%</span>
            </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-sm font-semibold text-gray-900">{dealScore}%</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div 
