          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-3">
            <div className="bg-white dark:bg-gray-800 p-3 rounded-lg">
              ...
              <div className="text-xs text-gray-600 dark:text-gray-300">
                {result.uniqueInsights.carbonFootprint}
              </div>
            </div>
            <div className="bg-white dark:bg-gray-800 p-3 rounded-lg">
              ...
              <div className="text-xs text-gray-600 dark:text-gray-300">
                {result.uniqueInsights.supplyChainRisk}
              </div>
            </div>
            <div className="bg-white dark:bg-gray-800 p-3 rounded-lg">
              ...
              <div className="text-xs text-gray-600 dark:text-gray-300">
                {result.uniqueInsights.brandTrustScore}/100
              </div>
            </div>
            <div className="bg-white dark:bg-gray-800 p-3 rounded-lg">
              ...
              <div className="text-xs text-gray-600 dark:text-gray-300">
                {result.uniqueInsights.hiddenCosts}
              </div>
            </div>
            <div className="bg-white dark:bg-gray-800 p-3 rounded-lg">
              ...
              <div className="text-xs text-gray-600 dark:text-gray-300">
                {result.uniqueInsights.futureValuePrediction}
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-gray-200 dark:border-slate-700 transition-all duration-300">
        <div className="space-y-4">
          ...
          {result.recommendation?.action && (
            <div
              className={`px-6 py-3 rounded-lg border text-center font-semibold ${getDecisionColorClass(result.decision)}`}
            >
              {result.recommendation.action}
            </div>
          )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-gray-200 dark:border-slate-700 transition-all duration-300">
          <div className="space-y-3">
            ...
            <div
              className={`text-3xl font-bold ${getScoreColorClass(result.dealScore)}`}
            >
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-gray-200 dark:border-slate-700 transition-all duration-300">
          <div className="space-y-3">
            ...
            <div
              className={`text-3xl font-bold ${getScoreColorClass(result.ethicalScore)}`}
            >
          ...
          <div className="space-y-3">
            ...
            <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
              ...
              <div
                ...
                style={{
                  width: `${result.trustScore?.dataReliability || 95}%`,
                }}
              />
            </div>
            <p className="text-xs text-gray-600 dark:text-gray-400">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-gray-200 dark:border-slate-700 transition-all duration-300">
          <div className="space-y-3">
            ...
            <div className="text-3xl font-bold text-blue-600 dark:text-blue-400">
              {Math.round(
                ((result.dealScore || 95) + (result.ethicalScore || 65)) / 2,
              )}
              /100
            </div>
            <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
              ...
              <div
                className="h-3 rounded-full bg-blue-500 transition-all duration-300"
                style={{
                  width: `${Math.round(((result.dealScore || 95) + (result.ethicalScore || 65)) / 2)}%`,
                }}
              />
            </div>
            <p className="text-xs text-gray-600 dark:text-gray-400">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span
                        className={`font-medium ${getScoreColorClass(variant.ethicalScore)}`}
                      >
              ...
              <div className="text-center p-4 bg-gray-50 dark:bg-slate-700/50 rounded-lg">
                <div
                  className={`text-2xl font-bold capitalize ${
                    result.marketStats.trendDirection === 'rising'
                      ? 'text-green-600 dark:text-green-400'
                      : result.marketStats.trendDirection === 'declining'
              ...
              >
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                    {alternative.reasonForRecommendation}
                  </p>
                </div>
                ...
                <div className="flex items-center gap-4">
                  <div className="text-center">
                    <div
                      className={`text-lg font-bold ${getScoreColorClass(alternative.ethicalScore)}`}
                    >
