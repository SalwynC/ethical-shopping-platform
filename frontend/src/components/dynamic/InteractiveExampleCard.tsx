...
export function InteractiveExampleCard({
  product,
  isSelected,
  onSelect,
  isAnalyzing,
          ...
          >
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                />
                <span className="text-sm font-semibold text-emerald-800 dark:text-emerald-200 group-hover/score:translate-x-1 transition-transform duration-200">
                  Price Score
                </span>
              </div>
              <motion.div
          ...
          >
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                />
                <span className="text-sm font-semibold text-blue-800 dark:text-blue-200 group-hover/review:translate-x-1 transition-transform duration-200">
                  Review Trust
                </span>
              </div>
              <motion.span
          ...
          >
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                />
                <span className="text-sm font-semibold text-purple-800 dark:text-purple-200 group-hover/ethics:translate-x-1 transition-transform duration-200">
                  Ethics Rating
                </span>
              </div>
              <motion.span
