...
import { IconExternalLink, IconAlertCircle, IconCheck, IconLoader2, IconSparkles } from "@tabler/icons-react";
...
export default function ComprehensiveAnalysisPage() {
  ...
  const simulateStepProgress = async () => {
    for (let i = 0; i < analysisSteps.length; i++) {
      ...
      const stepDuration = currentStep.id === 'ai-analysis' ? 3000 : 
                          currentStep.id === 'product-scraping' ? 2500 :
                          1500;
  ...
  const getCompletedMessage = (stepId: string): string => {
    const messages: Record<string, string> = {
      ...
      "product-scraping": "✅ Product data extracted successfully with anti-bot measures",
            ...
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300 mt-2 text-lg">
                  Advanced AI-powered product intelligence with unique competitive insights
                </p>
              </div>
              ...
              {!isAnalyzing && !analysisResult && (
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                    Includes ML price prediction, carbon footprint, supply chain analysis & more
                  </p>
                </div>
              )}
            </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                    <IconLoader2 className={`${isAnalyzing ? 'animate-spin' : ''} text-blue-500`} size={24} />
                  ...
                  {steps.map((step, index) => (
                    <motion.div 
                      ...
                      className={`flex items-center gap-4 p-4 rounded-xl transition-all ${
                        ...
                        step.status === 'in-progress' ? 'bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800' :
                    ...
                    >
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${
                        ...
                        {step.status === 'completed' ? <IconCheck size={20} /> :
                         step.status === 'in-progress' ? <IconLoader2 size={20} className="animate-spin" /> :
                         step.status === 'error' ? '❌' :
                         index + 1}
                      </div>
          ...
          {error && (
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-bold text-red-800 dark:text-red-200 mb-2">Analysis Failed</h3>
          ...
          {!productUrl && (
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-bold text-red-800 dark:text-red-200 mb-2">No Product URL Provided</h3>
