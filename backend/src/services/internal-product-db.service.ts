...
export class InternalProductDbService {
  ...
  private products: Product[] = [
    // Electronics - Premium Brands
    {
      ...
      features: ['6.1" display', 'A17 Pro chip', 'Advanced camera', 'USB-C', 'Premium design'],
      ethicalScore: 75,
    ...
    },
    {
      ...
      features: ['6.8" display', 'Snapdragon 8 Gen 3', 'S Pen included', '200MP camera', '5000mAh battery'],
      ethicalScore: 72,
    ...
    },
    {
      ...
      features: ['M3 Max chip', '36GB memory', '512GB SSD', '16" Retina display', '16 GPU cores'],
      ethicalScore: 76,
    ...
    // Fashion
    {
      ...
      features: ['Max Air cushioning', 'Durable rubber sole', 'Premium leather', 'Breathable mesh', 'Iconic design'],
      ethicalScore: 68,
    ...
    },
    {
      ...
      features: ['Boost cushioning', 'Primeknit upper', 'Continental rubber', 'Responsive', 'Lightweight'],
      ethicalScore: 70,
    ...
    },
    {
      ...
      features: ['100% recycled polyester', 'Lightweight insulation', 'Water resistant', 'Packable', 'Sustainable'],
      ethicalScore: 92,
    ...
    // Home & Kitchen
    {
      ...
      features: ['6.8" display', 'IPX8 waterproof', 'Backlit display', '11-week battery', '32GB storage'],
      ethicalScore: 65,
    ...
    },
    {
      ...
      features: ['Laser detection', '60 min runtime', '450W suction', 'Digital display', 'App control'],
      ethicalScore: 60,
      sustainabilityScore: 65,
    },
    // Beauty & Personal Care
    {
      ...
      features: ['Pure Vitamin C', 'Anti-aging', 'Brightening', 'Paraben-free', 'Suitable for all skin types'],
      ethicalScore: 62,
    ...
    },
    {
      ...
      features: ['100% natural', 'Organic ingredients', 'Cruelty-free', 'Eco-friendly packaging', 'Ayurvedic formula'],
      ethicalScore: 88,
    ...
    // Sports
    {
      ...
      features: ['Titanium case', 'Always-on display', 'GPS', 'Health tracking', 'Water resistant 100m'],
      ethicalScore: 74,
  ...
  getBetterAlternatives(product: Product, limit: number = 5): Product[] {
    ...
    return this.products
      .filter(p =>
        p.id !== product.id &&
        p.category === product.category &&
        (p.ethicalScore > product.ethicalScore || p.sustainabilityScore > product.sustainabilityScore) &&
